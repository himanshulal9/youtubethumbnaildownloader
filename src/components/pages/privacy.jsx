    ...
    <Fragment>
      ...
      <Box component={Container} p={2}>
        ...
        <Typography variant='body1'>
          Greatcoders built the youtubethumbnaildownloader.nettool.in app as a
          Free app. This SERVICE is provided by Greatcoders at no cost and is
          ...
          youtubethumbnaildownloader.nettool.in unless otherwise defined in this
          Privacy Policy.
        </Typography>
        <br />
        <Typography
        ...
        <Typography variant='body1'>
          ...
          but not limited to we collect nothinf from user. The information that
          ...
          party service providers used by the app Google Play Services Facebook
        </Typography>
        <br />
        <Typography
          variant='h5'
        ...
        <Typography variant='body1'>
          ...
          not hesitate to contact me at greatcoder1@gmail.com. This privacy
